...
const addStock = async(req, res) => {
 logRequestDetails(req, "addStock");
    try {
        ...
        const replacements = [productId, productName,productFlavor,productPrice, normalizeClientDateTime(lastUpdated), productQuantity];
...
const addStockedItems = async(req, res) => {
    ...
    try {
        ...
        // Parameterized query with replacements
        const replacements = [productId, normalizeClientDateTime(stockDate),stockId,stockPrice, stockQuantity];
